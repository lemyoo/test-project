                        ...
                        <h1 className="headingtext">User A</h1>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <div className="form-group">
                                    ...
                                    <input type="number" className="form-control" id="x" name="x" ref={register({ required: true })}/> 
                                </div>

                                <div className="form-group">
                                    <label htmlFor="fruits">Select A Fruit</label>
                                    <select className="form-control" id="fruits" name="fruits" ref={register({ required: true })}>
                                        <option>Apple</option>
                                        <option>Mango</option>
                                ...
                                <div className="form-group">
                                    ...
                                    <Form.Control type="date" name="date" id="date" ref={register({requirde: true})}/>
                                </div>
                                
                                <div className="form-group">
                                    <label htmlFor="time">Time</label>
                                    <Form.Control type="time" name="time" id="time" ref={register({requirde: true})}/>
                                </div>

                                <div className="form-group">
                                    <label htmlFor="y">Enter Number(Y)</label>
                                    <input type="number" className="form-control" name="y" id="y" ref={register({requirde: true})} />
                                </div>
